...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(709, 240)
        MainWindow.setMinimumSize(QtCore.QSize(709, 240))
        MainWindow.setMaximumSize(QtCore.QSize(709, 240))
        icon = QtGui.QIcon()
        ...
        self.lineEdit.setGeometry(QtCore.QRect(230, 60, 461, 31))
        font = QtGui.QFont()
        ...
        self.pushButton.setGeometry(QtCore.QRect(20, 60, 201, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(20, 110, 201, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(230, 110, 461, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(20, 160, 671, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.progressBar.setGeometry(QtCore.QRect(20, 160, 671, 31))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setTextVisible(False)
        self.progressBar.setObjectName("progressBar")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(230, 10, 251, 16))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        ...
        self.spinBox.setGeometry(QtCore.QRect(20, 10, 201, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.label_5.setGeometry(QtCore.QRect(230, 25, 131, 16))
        font = QtGui.QFont()
